...
All platforms:
[![noarch](https://img.shields.io/circleci/project/github/conda-forge/pypubsub-feedstock/master.svg?label=noarch)](https://circleci.com/gh/conda-forge/pypubsub-feedstock)
...
Once the `conda-forge` channel has been enabled, `pypubsub` can be installed with:

```
conda install pypubsub
```

It is possible to list all of the versions of `pypubsub` available on your platform with:
